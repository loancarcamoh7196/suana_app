...
class StarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create star" do
    assert_difference('Star.count') do
      post stars_url, params: { star: { detail_id: @star.detail_id, user_id: @star.user_id, value: @star.value } }
    end
  ...
  test "should update star" do
    patch star_url(@star), params: { star: { detail_id: @star.detail_id, user_id: @star.user_id, value: @star.value } }
