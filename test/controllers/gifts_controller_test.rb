...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post gifts_url, params: { gift: { available: @gift.available, description: @gift.description, name: @gift.name, points: @gift.points, quantity: @gift.quantity } }
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { available: @gift.available, description: @gift.description, name: @gift.name, points: @gift.points, quantity: @gift.quantity } }
